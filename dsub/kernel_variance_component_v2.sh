...
R CMD BATCH "--args ${chr4_gdsfile} ${chr4_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr4_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr4_logfile}
...
R CMD BATCH "--args ${chr12_gdsfile} ${chr12_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr12_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr12_logfile}
R CMD BATCH "--args ${chr13_gdsfile} ${chr13_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr13_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr13_logfile}
R CMD BATCH "--args ${chr14_gdsfile} ${chr14_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr14_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr14_logfile}
R CMD BATCH "--args ${chr15_gdsfile} ${chr15_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr15_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr15_logfile}
R CMD BATCH "--args ${chr16_gdsfile} ${chr16_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr16_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr16_logfile}
R CMD BATCH "--args ${chr17_gdsfile} ${chr17_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr17_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr17_logfile}
R CMD BATCH "--args ${chr18_gdsfile} ${chr18_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr18_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr18_logfile}
R CMD BATCH "--args ${chr19_gdsfile} ${chr19_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr19_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr19_logfile}
R CMD BATCH "--args ${chr20_gdsfile} ${chr20_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr20_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr20_logfile}
R CMD BATCH "--args ${chr21_gdsfile} ${chr21_groupfile} ${phenfile} ${ID_col} ${nullfile} ${chr21_outfile}" /phewas_genetic_analysis/src/kernel_variance_component.R ${chr21_logfile}
